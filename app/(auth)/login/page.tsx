  ...
  return (
    <div className="mx-auto flex min-h-[calc(100vh-64px)] max-w-[420px] flex-col justify-center px-6 py-12">
      <div className="rounded-[18px] border border-[#e7e9ec] bg-white p-10">
        <h2 className="mb-1.5 font-[var(--font-poppins)] font-bold tracking-tight text-[26px] font-bold tracking-tight">
          Welcome back
        </h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <Link href="/forgot-password" className="text-[12.5px] font-medium text-[#0f9d77] hover:underline">
                Forgot password?
              </Link>
            </div>
            <Input
