...
function VerifyContent() {
  ...
  if (error) {
    ...
    return (
      <div className="text-center">
        ...
        <h2 className="mb-2 font-[var(--font-space-grotesk)] text-[22px] font-bold">Verification failed</h2>
  ...
  return (
    <div className="text-center">
      ...
      <h2 className="mb-2 font-[var(--font-space-grotesk)] text-[22px] font-bold tracking-tight">Check your inbox</h2>
